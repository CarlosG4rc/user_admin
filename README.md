...
API user_admin ayuda a gestionar usuarios (crear, actualizar, visualizar y eliminar), dentro de los parámetros para creacion de usuarios se podrán asignar roles (admin, films, people, species, locations, vehicles)
...
<ul>
  ...
  <li align="left">En la siguiente línea de comandos te aparecerá la liga local con la que podrás ejecutar las pruebas locales.</li>
</ul>
...
<p align="left">Los tipos de datos que se manden en cada campo son:</p>
...
Las opciones para el parámetro de rol debe ser:
<ul>
  <li>admin</li>
  <li>films</li>
  <li>people</li>
...
En seguida te aparecerá el estatus 200 y un texto de confirmación.
...
<p align="left">En este caso no necesitamos ningún parámetro.</p>
...
<p align="left">Method: GET</p>
<p align="left">Para traer a un usuario específico debemos enviar por medio del URL el id usuario mostrado en el endpoint anterior</p>
...
<p align="left">Los requisitos para obtener actualizar los datos de un usuario es:</p>
<p align="left">URL: http://localhost:5000/users/:id</p>
<p align="left">Method: PATCH</p>
<p align="left">Para actualizar a un usuario específico debemos enviar por medio del URL el id usuario mostrado en el endpoint que trae todos los usuarios</p>

<h3>Body:</h3>

Para que funcione correctamente este endpoint se necesita enviar en el body un JSON en donde venga qué parámetro se va a modificar y porque dato será modificado como se muestra enseguida:
...
```
Tenemos los siguientes usuarios según el endpoint anterior:
...
<h2>Borrado de usuario específico</h2>

<p align="left">Los requisitos para borrar a un usuario son:</p>
<p align="left">URL: http://localhost:5000/users/:id</p>
<p align="left">Method: DELETE</p>
<p align="left">Para borrar a un usuario específico debemos enviar por medio del URL el id usuario mostrado en el endpoint que trae todos los usuarios</p>
...
Si tenemos el rol de films podemos obtener todos los films del estudio o un film en específico:

El primer endpoint a usar tiene las siguientes características:
...
Si no mandamos ningún parámetro por body obtendremos todo el catálogo como se muestra a continuación:
...
Si tenemos el rol de people podemos obtener todos las personas del estudio o de una person en específico:
...
<p align="left">Method: POST</p>
<p align="left">Con este endpoint podemos obtener los datos de todas las especies del studio incluidos humanos, animales y espíritus, en caso de que el id provisto sea de un usuario que tiene el rol de people o admin de lo contrario el acceso será restringido</p>
...
<p align="left">Method: POST</p>
<p align="left">Con este endpoint podemos obtener los datos de todos los vehículos, en caso de que el id provisto sea de un usuario que tiene el rol de people o admin de lo contrario el acceso será restringido</p>
...
Espero sea de utilidad este proyecto, cualquier duda puedes contactarme o comentarme en la sección de issues. También acepto sujerencias y recomendaciones.
